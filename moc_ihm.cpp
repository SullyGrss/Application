...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_IHM_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_IHM_t qt_meta_stringdata_IHM = {
    {
QT_MOC_LITERAL(0, 3) // "IHM"
...
const QMetaObject IHM::staticMetaObject = { {
    ...
    qt_meta_stringdata_IHM.offsetsAndSize,
    qt_meta_data_IHM,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_IHM_t
, QtPrivate::TypeAndForceComplete<IHM, std::true_type>
